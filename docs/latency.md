...
Single-thread match on one of 32 symbols is ~3 µs median. Cost grows with
instrument map lookups / book depth, not with a contended shared lock. No
hotspot yet that justifies shard-by-symbol threading; keep measuring before
adding concurrency.
